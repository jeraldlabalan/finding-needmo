...
(23, 'Society Officer', 'ldko@gmail.com', '123', 'Society Officer', 'uploads\\default-pfp.jpg', 'Active'),
...
(30, 'Transferee Transfer', 'transfeeer@gmail.com', '123', 'Student', 'uploads\\default-pfp.jpg', 'Active'),
(31, 'Donna Pauline Virtudez', 'bc.donnapauline.virtudez@cvsu.edu.ph', 'EEknyWtw', 'Student', 'uploads\\default-pfp.jpg', 'Active'),
(32, 'Neil Yvan Caliwan', 'bc.neilyvan.caliwan@cvsu.edu.ph', 'KtxbJe5v', 'Student', 'uploads\\default-pfp.jpg', 'Active'),
(33, 'CS Soc Officer', 'kas@gmail.com', '123', 'Society Officer', 'uploads\\default-pfp.jpg', 'Active'),
(34, 'CS DCS Head', 'cshead@gmail.com', '123', 'DCS Head', 'uploads\\default-pfp.jpg', 'Active');
...
(1, 52, 98123, 'uploads\\1734154045423.png', 'CvSU - Bacoor', '1st Year 1st Sem', 6770, 13678, 'STEM', 90, 90, 90, 90, 0, 1111, 'Catholic', 'Filipino', 'Single', 'No', '', 'No', '', 'John A. Doe', '09213823', 'superman', 'Jane B. Doe', '09238238', 'superwoman', 'Jane B. Doe', 'tropa', '09391738713', 'superhero', 1, 'Eldest', 'above 50,000', 'elem', 'klqjlekqwj', '2000', 'Public', 'jhs', 'doon', '2001', 'Public', 'sjkhdjkhjkhe', 'lkjqwlejlqwe', '2001', 'Public', '', '', '0000', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '2024-12-27 11:33:00', 'School Head', '2024-12-28', 'Approved'),
(2, 70, NULL, 'uploads\\1735109359323.png', 'CvSU - Bacoor', '2nd Year 1st Sem', 75368, 136783, NULL, NULL, NULL, NULL, NULL, NULL, 1234, 'Catholic', 'Filipino', 'Single', 'No', '', 'No', 'undefined', 'John A. Doe', '092372738', 'superman', 'Jane B. Doe', '09213278137', 'superwoman', 'Jane B. Doe', 'Momsh', '09213278137', 'superhero', 2, 'Youngest', '21,000 - 30,000', 'elem', 'elem address', '2000', 'Public', 'jhs', 'jhs address', '2007', 'Private', 'shs', 'shs address', '2010', 'Private', '', '', '0000', '', 'college', 'college address', 'Bachelor of Science in Information Technology', 'Private', NULL, NULL, NULL, NULL, '', '', NULL, NULL, NULL, 'Submitted');
...
(48967245, 1, 'CS DCS', '', 'Head', 'cshead@gmail.com', '0921377156425', NULL, NULL, NULL, NULL, 'DCS Head', 'Employed', 'Accepted');
...
--
-- Table structure for table `enrollmentperiod`
--

CREATE TABLE `enrollmentperiod` (
  `EnrollmentPeriodID` int(11) NOT NULL,
...
--
-- Dumping data for table `enrollmentperiod`
--

INSERT INTO `enrollmentperiod` (`EnrollmentPeriodID`, `ProgramID`, `SocietyOfficerID`, `Start`, `End`, `Status`) VALUES
(1, 1, NULL, NULL, NULL, 'Finished'),
(2, 2, NULL, NULL, NULL, 'Finished');
...
INSERT INTO `requirements` (`RequirementsID`, `StudentID`, `SocietyOfficerID`, `SocFeePayment`, `COG`) VALUES
(1, 62, NULL, 'Pending', NULL),
(2, 66, NULL, 'Pending', NULL),
(3, 67, NULL, 'Pending', NULL);
...
(3, 222222, NULL, '2023-2024', '1. Ayoko na suko na ang eabab na ito\n2. Ayaw na\n3. Suko na', '2024-12-19', 'Ms. Teacher', 'CvSU - Bacoor', NULL, 'Submitted');
...
--
-- Dumping data for table `slotconfirmation`
--

INSERT INTO `slotconfirmation` (`SlotConfirmationID`, `AdmissionID`, `IsSlotConfirmed`) VALUES
(2, 1, 1);
...
(2, 1, 'CS Soc', 'sadasd', 'Officer', 'kas@gmail.com', '0921387213', NULL, 'M', NULL, 'Assistant P.R.O.', 'Elected', 'Accepted');
...
(52, 1, NULL, 'Gerlyn', 'Rama', 'Tan', 'tangr.stem.dccs@gmail.com', 'F', 20, '098723897213', 'Sa tabi lang', '2024-09-12', 'Freshman', NULL, NULL, NULL, NULL, 'dccs', 'Active', 'Accepted'),
...
(62, 1, 202211701, 'Neil Yvan', 'Sandoval', 'Caliwan', 'bc.neilyvan.caliwan@cvsu.edu.ph', NULL, NULL, '092138721551', NULL, NULL, 'Regular', NULL, NULL, NULL, NULL, NULL, 'Active', 'Accepted'),
(63, 1, 202211734, 'Jessica', 'Hernandez', 'Dimailig', 'bc.jessica.dimailig@cvsu.edu.ph', NULL, NULL, NULL, NULL, NULL, 'Regular', NULL, NULL, NULL, NULL, NULL, 'Active', 'Pending'),
(64, 1, 202211880, 'Jennylle', 'Cebrian', 'Adao', 'bc.jennyllefate.adao@cvsu.edu.ph', NULL, NULL, NULL, NULL, NULL, 'Irregular', NULL, NULL, NULL, NULL, NULL, 'Active', 'Pending'),
(65, 1, 202211769, 'Anne Aubrey', 'Pagaduan', 'Gripon', 'bc.anneaubrey.gripon@cvsu.edu.ph', NULL, NULL, NULL, NULL, NULL, 'Regular', NULL, NULL, NULL, NULL, NULL, 'Active', 'Pending'),
...
(67, 1, 202211874, 'Donna Pauline', 'Forbile', 'Virtudez', 'bc.donnapauline.virtudez@cvsu.edu.ph', NULL, NULL, '09271503286', NULL, NULL, 'Regular', NULL, NULL, NULL, NULL, NULL, 'Active', 'Accepted'),
...
(70, 2, NULL, 'Transferee', 'T', 'Transfers', 'transfeeer@gmail.com', 'F', 20, '09123874145', 'Doon', '2024-11-08', 'Transferee', NULL, NULL, NULL, NULL, 'Perps', 'Active', 'Accepted');
...
--
-- Indexes for table `enrollmentperiod`
--
ALTER TABLE `enrollmentperiod`
  ADD PRIMARY KEY (`EnrollmentPeriodID`),
  ADD KEY `enrollmentperiod_ibfk_1` (`SocietyOfficerID`),
  ADD KEY `ProgramID` (`ProgramID`);
...
--
-- AUTO_INCREMENT for table `enrollmentperiod`
--
ALTER TABLE `enrollmentperiod`
  MODIFY `EnrollmentPeriodID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `requirements`
  MODIFY `RequirementsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `slotconfirmation`
  MODIFY `SlotConfirmationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Constraints for table `enrollmentperiod`
--
ALTER TABLE `enrollmentperiod`
  ADD CONSTRAINT `enrollmentperiod_ibfk_1` FOREIGN KEY (`SocietyOfficerID`) REFERENCES `societyofficer` (`SocietyOfficerID`),
  ADD CONSTRAINT `enrollmentperiod_ibfk_2` FOREIGN KEY (`ProgramID`) REFERENCES `societyofficer` (`ProgramID`);
